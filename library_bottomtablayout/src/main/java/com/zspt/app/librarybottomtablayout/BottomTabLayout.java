package com.zspt.app.librarybottomtablayout;
...
public class BottomTabLayout extends LinearLayout {
    ...
    public static class TabItemView extends LinearLayout {
         ...
         */
        public void init() {
            View view = LayoutInflater.from(super.getContext()).inflate(R.layout.layout_bottom_tab_item, this);

            ivIcon = view.findViewById(R.id.bil_bottom_tab_layout_item);
